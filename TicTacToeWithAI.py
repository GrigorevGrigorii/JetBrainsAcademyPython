...
class TicTacToe:
    ...
    def make_a_move(self, whose_move):
        if not self.over():
            while True:
    ...
    def processing_command(command):
        if command == "exit":
            ...
            if command.split()[0] == 'start' and command.split()[1] == 'user' and command.split()[2] == 'user':
                game = TicTacToe()
                print(game)
                while not game.over():
                    game.make_a_move("X")
            ...
            elif command.split()[0] == 'start' and command.split()[1] == 'user' and command.split()[2] == 'easy':
                game = TicTacToe()
                print(game)
                while not game.over():
                    game.make_a_move("X")
                ...
                print(game.state_of_game)
            elif command.split()[0] == 'start' and command.split()[1] == 'easy' and command.split()[2] == 'user':
                game = TicTacToe()
                print(game)
                while not game.over():
                    ...
                    game.make_a_move("O")
                print(game.state_of_game)
            elif command.split()[0] == 'start' and command.split()[1] == 'easy' and command.split()[2] == 'easy':
                game = TicTacToe()
                print(game)
                while not game.over():
                    game.make_a_move_easy("X")
